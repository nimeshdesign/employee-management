...
function RosterGrid({ employees, dates, assignments, conflicts, onDropShift }) {
  ...
  return (
    <div
      ...
      className="max-h-[calc(100dvh-20rem)] w-full overflow-auto rounded-xl border border-gray-200 bg-white dark:border-gray-700 dark:bg-gray-800"
    >
